...
import com.shop.shopping.shoppingcart.dto.response.CouponInfoResponse;
...
public interface CouponRedemptionRepository extends JpaRepository<CouponRedemption, Long> {
    ...
    @Query ("SELECT new com.shop.shopping.shoppingcart.dto.response.CouponInfoResponse( c.name, c.discountType, c.discountValue)"+
    ...
    @Query("SELECT new com.shop.shopping.coupons_points.dto.coupon.UserCouponResponse( c.startsAt, c.endsAt, c.name, c.discountType,c.discountValue, cr.status) " +
            "FROM CouponRedemption cr " +
            "JOIN cr.coupon c " +
